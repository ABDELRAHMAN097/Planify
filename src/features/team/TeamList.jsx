...
const TeamList = () => { 
  ...
  return (
    <div className="min-h-[calc(100vh-64px) dark:bg-gray-900 dark:text-white py-12 px-4">
      <h1 className="text-4xl font-bold text-center mb-12 text-gray-800 dark:text-white">Team Work</h1>
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8 max-w-6xl mx-auto dark:bg-gray-900 dark:text-white">
        {team.map(member => (
          <motion.div
            key={member.id}
            className="relative cursor-pointer dark:bg-gray-900 dark:text-white"
